    ...
    authFetch(API_ENDPOINTS.SETTINGS)
      ...
      .then(data => {
        setSettings({
          ...
          OLLAMA_ENDPOINT: data.OLLAMA_ENDPOINT ?? DEFAULT_SETTINGS.OLLAMA_ENDPOINT,
          OLLAMA_MODEL: data.OLLAMA_MODEL ?? DEFAULT_SETTINGS.OLLAMA_MODEL,
          CLAUDE_MEM_GEMINI_CLI_BINARY: data.CLAUDE_MEM_GEMINI_CLI_BINARY ?? DEFAULT_SETTINGS.CLAUDE_MEM_GEMINI_CLI_BINARY,
          CLAUDE_MEM_GEMINI_CLI_MODEL: data.CLAUDE_MEM_GEMINI_CLI_MODEL ?? DEFAULT_SETTINGS.CLAUDE_MEM_GEMINI_CLI_MODEL,
          CLAUDE_MEM_PREFER_COST_OPTIMIZATION: data.CLAUDE_MEM_PREFER_COST_OPTIMIZATION ?? DEFAULT_SETTINGS.CLAUDE_MEM_PREFER_COST_OPTIMIZATION,
          CLAUDE_MEM_TASKS: data.CLAUDE_MEM_TASKS ?? DEFAULT_SETTINGS.CLAUDE_MEM_TASKS,
        });
      })
      .catch(error => {
