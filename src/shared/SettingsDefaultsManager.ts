...
export interface SettingsDefaults {
  ...
  CLAUDE_MEM_CLAUDE_CLI_BINARY: string;
  CLAUDE_MEM_CLAUDE_CLI_MODEL: string;
  CLAUDE_MEM_CODEX_CLI_BINARY: string;
  CLAUDE_MEM_CODEX_CLI_MODEL: string;
  CLAUDE_MEM_COPILOT_CLI_BINARY: string;
  CLAUDE_MEM_COPILOT_CLI_MODEL: string;
  CLAUDE_MEM_OPENCODE_CLI_BINARY: string;
  CLAUDE_MEM_OPENCODE_CLI_MODEL: string;
  CLAUDE_MEM_THERMIS_CLI_BINARY: string;
  CLAUDE_MEM_THERMIS_CLI_MODEL: string;
...
export class SettingsDefaultsManager {
  private static readonly DEFAULTS: SettingsDefaults = {
    ...
    CLAUDE_MEM_CLAUDE_CLI_BINARY: 'claude',
    CLAUDE_MEM_CLAUDE_CLI_MODEL: 'claude-3-5-sonnet-latest',
    CLAUDE_MEM_CODEX_CLI_BINARY: 'codex',
    CLAUDE_MEM_CODEX_CLI_MODEL: 'default',
    CLAUDE_MEM_COPILOT_CLI_BINARY: 'copilot',
    CLAUDE_MEM_COPILOT_CLI_MODEL: 'default',
    CLAUDE_MEM_OPENCODE_CLI_BINARY: 'opencode',
    CLAUDE_MEM_OPENCODE_CLI_MODEL: 'default',
    CLAUDE_MEM_THERMIS_CLI_BINARY: 'thermis',
    CLAUDE_MEM_THERMIS_CLI_MODEL: 'default',
